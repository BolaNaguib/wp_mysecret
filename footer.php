...
?> <audio style="position: fixed;
    ...
    .loaded {
        display: none;
    }</style><!-- START loadercontainerx --><div class="loadercontainerx"><!-- START loader --><div class="loadercontainer"><div class="loader"><div class="spinner yellow"></div><div class="spinner orange"></div><div class="spinner red"></div><div class="spinner pink"></div><div class="spinner violet"></div><div class="spinner mauve"></div><div class="spinner light-yellow"></div></div></div><!-- END loader --></div><!-- END loadercontainerx --><script>$(document).ready(function() {
