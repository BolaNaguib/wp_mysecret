    ...
    <div class='' style="padding:0 10px;" >
        ...
        <div class='uk-text-center'>
            ...
            <div class='section-header'>
                <h2 class="title uk-margin-remove">Brands</h2>
        ...
        <div class='uk-grid uk-grid-match'>
            <?php for ($i = 0; $i < 8; $i++) : ?>
                <!-- START uk-width-1-4@m uk-width-1-2 -->
                <div class='uk-width-1-4@m uk-width-1-2'>
                    <!-- START brands-card -->
                    <div class='brands-card'>
                        <img src="http://alices-html.themerex.net/images/2.png" alt="">
                    </div>
                    <!-- END brands-card -->
                </div>
                <!-- END uk-width-1-4@m uk-width-1-2 -->
            <?php endfor; ?>
        </div>
        <!-- END uk-grid -->
    </div>
